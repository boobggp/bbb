...
const myBot = ['udbc79ce16f1ccee17dadba2d30d7cbd0','u6255273dbc2082e498ed7aa2f1021847'];//TARO MID LU DISINI
...
if(operation.type == 13) { // diinvite
    ...
    async textMessage(textMessages, seq) {
        ...
        if(cmd == 'spm' ) { // untuk spam invite contoh: spm <mid> kadang masih ngebug
